<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCompetence.aspx.cs" Inherits="CompetenceManager.EditCompetence" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,Name" OnRowDeleting="GridView1_RowDeleting" ShowFooter="True" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Тип" SortExpression="Type">
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddl_CompType" runat="server">
                                    <asp:ListItem Value="Базовая">Базовая</asp:ListItem>
                                    <asp:ListItem Value="Профессиональная">Профессиональная</asp:ListItem>
                                </asp:DropDownList>
                            </EditItemTemplate>
                            <FooterTemplate>
                                <asp:DropDownList ID="ddl_NewCompType" runat="server">
                                    <asp:ListItem Value="Базовая">Базовая</asp:ListItem>
                                    <asp:ListItem Value="Профессиональная">Профессиональная</asp:ListItem>
                                </asp:DropDownList>
                            </FooterTemplate>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton4" runat="server" CausesValidation="False" CommandName="Edit" Text="Правка"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
